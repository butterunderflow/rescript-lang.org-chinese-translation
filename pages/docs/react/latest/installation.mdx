...
在你的ReScript项目中添加下面的依赖（如果你还没有项目，可以查看此[installation instructions](/docs/manual/latest/installation)手册
...
现在，现在，运行命令`npx rescript`就可以成功的构建项目了。
